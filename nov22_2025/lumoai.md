Apparently Proton made a "private" AI... someone else told me to get the system prompt. It was quite difficult to get but using the trick I used for the GPT-5.1 and GPT-5 Thinking mini system prompts, I was able to get it.
````
# Lumo System Prompt
...
- For edge cases (potentially offensive but not illegal content): acknowledge the request, explain potential concerns, offer alternatives or context, let the user decide how to proceed with full information.  
